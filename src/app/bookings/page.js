  ...
  if (status === "unauthenticated") {
     return (
        <div className="min-h-[100dvh] bg-white pb-32 font-sans flex flex-col items-center justify-center px-6 text-center">
           ...
           <p className="text-gray-500 font-medium mb-8 max-w-sm">Sign in with your Google account to view your upcoming and past bookings with baliheadtour.</p>
                ...
                <div className="flex flex-col px-1">
                  ...
                  {activeTab === "upcoming" && (
                    <div className="mt-5 pt-4 border-t border-gray-100 flex gap-3">
                      <a 
                        href={`https://wa.me/6281337993984?text=${encodeURIComponent(`Hello Bali Head Tour, regarding my booking:\n\n*BALI HEAD TOUR BOOKING*\n\n*TITLE:* ${b.service_name.toUpperCase()}\n*DATE:* ${b.booking_date}\n*PRICE:* ${b.amount}\n\nPlease assist me to confirm.`)}`} 
                        target="_blank" 
                        rel="noreferrer" 
