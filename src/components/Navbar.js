...
import { Search, MapPin, Globe, Menu, Bell, Settings2, ChevronDown, Map, Bus, Sparkles, Car } from "lucide-react";
    ...
    <header className={`fixed z-50 transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] left-1/2 -translate-x-1/2 w-full ${isScrolled ? "top-0 bg-white md:bg-white/90 md:backdrop-blur-md shadow-sm border-b border-border md:top-4 md:w-[85%] md:max-w-[1000px] md:rounded-full md:shadow-[0_8px_30px_rgb(0,0,0,0.08)] md:border md:border-gray-100 md:py-2.5" : "top-0 bg-white md:bg-transparent md:border-b-0 md:w-[95%] md:max-w-[1400px] md:py-5 pt-4 pb-4"}`}>
      ...
      <div className="md:hidden px-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <a href="https://wa.me/6281234567890?text=Hello%20Bali%20Head%20Tour!%20I%20would%20like%20to%20plan%20a%20trip%20with%20you." target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group">
            <div className="w-11 h-11 bg-[#25D366] rounded-full flex justify-center items-center shadow-sm group-hover:scale-105 transition-transform">
            ...
            <div className="flex flex-col">
              <span className="text-[13px] font-extrabold text-[#25D366]">Chat on WhatsApp</span>
              <span className="text-[10px] text-text-secondary mt-0.5 font-medium">Quick responses 24/7</span>
            </div>
          </a>
        </div>
      ...
      <div className="hidden md:flex container mx-auto px-6 w-full items-center justify-between">
        ...
        <div className="flex-1 items-center justify-end gap-3 flex">
          ...
          <a href="https://wa.me/6281234567890?text=Hello%20Bali%20Head%20Tour!%20I%20would%20like%20to%20plan%20a%20trip%20with%20you." target="_blank" rel="noopener noreferrer" className={`w-9 h-9 rounded-full flex items-center justify-center transition-all duration-500 shadow-soft ${isScrolled ? 'bg-[#25D366] text-white hover:scale-105 active:scale-95' : 'bg-[#25D366]/90 backdrop-blur-md text-white hover:bg-[#25D366]'}`}>
